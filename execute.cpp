...
void setNegativeAndZero(int result) {
  if (result < 0) {
    flags.N = 1;
    flags.Z = 0;
  }
  ...
  switch(itype) {
    ...
    case COND:
      ...
      if (checkCondition(cond.instr.b.cond)){
          ...
          if (int(2 * signExtend8to32ui(cond.instr.b.imm)) > 0) {
